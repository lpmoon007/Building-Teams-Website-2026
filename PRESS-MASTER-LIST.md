# Press & Media — Master Reference List

Consolidated inventory of every press/media mention supplied for Building Teams /
Be Legendary / Repario Ltd. / The Carter Group (all the same founder, **James Carter**).
Sources: the URL lists provided in chat + 10 supplied PDFs.

**Verification caveats (how to read the Status column):**
- Link-checking was done from a sandbox where **WebFetch is 403-blocked by every one of
  these hosts** (a 403 = "bot-blocked," *not* "dead" — none returned 404), and the
  **Wayback Machine was unreachable** (archive.org blocked at the proxy). So
  "dead / restructured" verdicts rest on search evidence about CMS/URL changes, and the
  archive snapshots below should be re-confirmed from an unrestricted browser.
- Legend: ✅ **LIVE (confirmed)** · 🟢 **LIVE (bot-blocked, high confidence)** ·
  🗄️ **ARCHIVE — use Wayback** · 🔴 **DEAD / restructured** · 🖨️ **PRINT — no URL in file** ·
  ♻️ **DUPLICATE**
...
**"Links to" column** — derived by cross-referencing the press source URLs against the
Semrush backlink exports for **buildingteams.com** and **belegendary.org**, plus the
outbound links embedded in the supplied PDFs. "not in backlink index" = Semrush shows no
live link (almost always because the source page is dead/restructured); it is not proof a
link never existed — recover via Wayback to confirm. **Only four sources carry a live,
indexed backlink: #5, #21, #22, #23.**
...
| 14 | Meetings Focus | Article 7918 | Jan 2007 | http://www.meetingsfocus.com/ArticleDetails/tabid/162/ArticleID/7918/Default.aspx | not in backlink index | 🔴 DEAD — rebranded to Meetings Today (2015); old DNN URLs not migrated | Repario / Building a Dream |
| 15 | RISMedia | "Going the Extra Mile: Team Building Puts Focus on Good Deeds" | 4-02-2008 | http://rismedia.com/2008-04-02/going-the-extra-mile-team-building-puts-focus-on-good-deeds/ | not in backlink index | 🟠 Domain live; try slash-date `rismedia.com/2008/04/02/going-the-extra-mile-team-building-puts-focus-on-good-deeds/` | Give-back team building |
| 16 | Leapfrog Innovations | "something.htm" (wartsNew) | 1-28-2008 | http://www.leapfroginnovations.com/wartsNew/something.htm | not in backlink index | 🔴 DEAD page (domain live: `leapfroginnovations.com`) | — |
| 17 | **DaVita — Investors** | "DaVita Service Event Sets GUINNESS WORLD RECORDS™ Title" | 4-27-2017 | https://investors.davita.com/2017-04-27-DaVita-Service-Event-Sets-GUINNESS-WORLD-RECORDS-TM-Title | mention only (no link) | ✅ **LIVE (confirmed)** | 979 bikes, Be Legendary |
| 18 | PRNewswire | "DaVita Service Event Sets Guinness World Records Title" | 4-27-2017 | https://www.prnewswire.com/news-releases/davita-service-event-sets-guinness-world-records-title-300446968.html | mention only (no link) | 🟢 LIVE (bot-blocked; PRNewswire retains permanently) | Guinness / Be Legendary |
| 19 | DaVita — Newsroom | Press releases index | — | https://newsroom.davita.com/press-releases/ (orig. `…/press-releases-879/`) | mention only (no link) | 🟢 LIVE listing (use canonical index) | — |
| 20 | **Business Destinations** | "Risky business" — by Nash Riggins | — | https://www.businessdestinations.com/work/risky-business/ | mention only (no link) | ✅ **LIVE (confirmed)** | Quotes "James Carter, founder of Be Legendary"; San Juan snow-cave program |
...
### A. Live & usable right now (link these)
- **#22 CNN (2012 Extreme retreats)** — ⭐ **live DOFOLLOW → buildingteams.com** (the single most valuable link to the primary domain)
- **#23 CNN (2018 …recharge)** — ⭐ **live DOFOLLOW → belegendary.org** (builds belegendary.org, not buildingteams.com)
- **#17 DaVita Investors** — Guinness release ✅ (strongest single credibility asset)
- **#20 Business Destinations — "Risky business"** ✅ (names James Carter / Be Legendary)
- **#21 Business Insider — $25K executive getaways** 🟢 (nofollow link to belegendary.org)
...
## Notes
- **Founder identity across all mentions:** The Carter Group Inc. (first company) →
  Repario Ltd. (Latin, "to renew/rediscover") → Be Legendary (2010 DBA) → Building Teams.
  All are James Carter. The SHRM "James Carter / The Carter Group" is the same person,
  not a name collision.
- **Backlink reality (cross-referenced against both Semrush exports):** only **four**
  sources carry a live, indexed backlink —
  - **#22 CNN 2012 → buildingteams.com — DOFOLLOW** (the one link that actually feeds the
    primary domain's authority). Its legacy target
    `/Executive_Teambuilding/executive_teambuilding.htm` **already 301-redirects** to
    `/executive-team-building/` (.htaccess line 204), so the equity flows. ✅ verified.
  - **#23 CNN 2018 → belegendary.org — DOFOLLOW** (helps belegendary.org, not buildingteams.com).
  - **#21 Business Insider → belegendary.org — nofollow.**
  - **#5 PRLog → buildingteams.com — nofollow** (from the biz.prlog.org/BeLegendary profile).
  - Everything else is "not in backlink index" (source page dead/restructured) or a text
    mention with no outbound link.
- **Founder cross-domain note:** two of the strongest links point at **belegendary.org**,
  a separate low-authority domain — that equity does not accrue to buildingteams.com.
- To finish B/E verification, re-run the Wayback lookups from an unrestricted network:
  `https://web.archive.org/web/2015/<original-URL>` jumps to the nearest snapshot.
